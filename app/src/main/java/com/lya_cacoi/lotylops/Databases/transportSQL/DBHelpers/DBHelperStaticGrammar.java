...
import static com.lya_cacoi.lotylops.Databases.transportSQL.contracts.SqlGrammarContract.GrammarEntry.CREATE_STATIC_COMMAND;
import static com.lya_cacoi.lotylops.Databases.transportSQL.contracts.SqlGrammarContract.GrammarEntry.DROP_STATIC_TABLE;

public class DBHelperStaticGrammar extends SQLiteOpenHelper {
    public static final String NAME = "grst.db";
    public static final int VERSION = 3;

    public DBHelperStaticGrammar(@Nullable Context context) {
